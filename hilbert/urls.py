...
urlpatterns = patterns('',
    ...
    url(r'^automaton/data', 'apps.automaton.views.data'),
    url(r'^automaton', 'apps.automaton.views.index'),

    url(r'^graph/data', 'apps.graph.views.data'),
    url(r'^graph', 'apps.graph.views.index'),
